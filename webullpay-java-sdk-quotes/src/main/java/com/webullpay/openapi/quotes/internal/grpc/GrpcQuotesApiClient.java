...
import com.webullpay.openapi.grpc.exception.ErrorResponseException;
...
import com.webullpay.openapi.quotes.api.lifecycle.ReplyMessage;
...
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.ApiLoggingHandler;
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.channel.ApiGrpcChannel;
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.channel.GrpcChannel;
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.channel.GrpcStreamChannelPoolMap;
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.channel.GrpcStreamEndpoint;
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.channel.SingletonChannelPool;
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.channel.StreamObserverFactory;
import com.webullpay.openapi.quotes.internal.grpc.lifecycle.proxy.ApiHandlerProxyFactory;
import com.webullpay.openapi.quotes.internal.grpc.proto.Api;
import com.webullpay.openapi.quotes.internal.grpc.proto.Gateway;
import com.webullpay.openapi.quotes.internal.grpc.proto.QuoteGrpc;
    ...
    public List<Bar> getBars(String symbol, String category, String timespan, int count) {
        ...
        try {
            ...
            return barResponses.stream().map(r -> {
                Bar bar = new Bar();
                bar.setTimestamp(r.getTimestamp());
    ...
    public List<Snapshot> getSnapshots(Set<String> symbols, String category) {
        ...
        try {
            ...
            return snapshotResponses.stream().map(r -> {
                ...
                snapshot.setTradeTimestamp(r.getTradeTimestamp());
